...
const TermsOfUse = () => {
  return (
    <div className='mt-5 mb-5'>
      ...
      <p>
        By accessing this Website, accessible from https://www.letsmakeitonline.com/,
      ...
      <p>
        ...
        on LetsMakeItOnline's Website for personal, non-commercial transitory
      ...
      <ul>
        ...
        <li>attempt to reverse engineer any software contained on LetsMakeItOnline's Website;</li>
        <li>remove any copyright or other proprietary notations from the materials; or</li>
        <li>transferring the materials to another person or "mirror" the materials on any other server.</li>
      </ul>

      <p>
        This will let LetsMakeItOnline terminate upon violations of any of these
      ...
      <p>
        Any claim related to LetsMakeItOnline's Website shall be governed by the
        laws of pt without regards to its conflict of law provisions.
      </p>
    </div>
  );
};
