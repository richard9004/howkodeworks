...
>
  ...
  <button type="submit" className="btn btn-sm btn-success"><i className="fa fa-save"></i> Update</button>
  <button type="button" className="btn btn-sm btn-secondary ms-2" onClick={closeModal}>Close</button>
</div>
