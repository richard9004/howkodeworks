...
function EditCategory(props) {
  const { isOpen, onClose, refreshCategories, tempCatData } = props;
  ...
  const updateCategoryData = async (data) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_API_BASE_URL}/updateCategory/${category_id}`,
        {
          id: category_id,
          title: catData.title,
      ...
      // REALTIME EXAMPLES
      toast.success("Success ! Category updated succesfully", {
